...
public class Reference {
    public static final String MODID = "tnt_utilities";
    public static final String MODNAME = "TNTUtils";
    public static final String VERSION = "@VERSION@";
    public static final String CLIENT_PROXY_CLASS = "ljfa.tntutils.proxy.CommonProxy";
