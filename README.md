...
A Minecraft mod that provides some config options for controlling explosions and the damage dealt by them. Uses a very simple multiloader setup to support NeoForge and Fabric.
